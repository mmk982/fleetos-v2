...
import {
  deleteDrawingAttachmentAction,
  uploadDrawingAttachmentAction,
  type DrawingActionState,
} from "@/modules/drawings/actions";
import type { DrawingAttachmentRow } from "@/db/schema";
...
export function DrawingAttachments({ drawingId, attachments }: Props) {
  const [state, formAction, pending] = useActionState(
    uploadDrawingAttachmentAction,
    undefined as DrawingActionState | undefined,
  );
        ...
        {attachments.length === 0 ? (
          ...
          attachments.map((a) => (
            ...
            >
              ...
              <form action={deleteDrawingAttachmentAction}>
