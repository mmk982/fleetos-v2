  ...
  try {
    ...
    return (
      <main className="flex flex-1 flex-col p-4 sm:p-8" dir="auto">
        ...
        <SettingsSubnav />
        <UsersRolesPanel users={users} vessels={vessels} />
      </main>
    );
  } catch (error) {
    if (error instanceof ForbiddenError) {
      return (
        <main className="flex flex-1 flex-col p-4 sm:p-8" dir="auto">
          <SettingsSubnav />
          <div className="mt-6 rounded-lg border border-amber-200 bg-amber-50 px-4 py-6 text-sm text-amber-900 dark:border-amber-900/50 dark:bg-amber-950/40 dark:text-amber-100">
